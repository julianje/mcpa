fishers.pow <- function(means, var, n, r = 10000, alternative = c("two.sided", "less", "greater"), mu = NULL, alpha = 0.05){
  ...
  CI <- exactci(round(power*r), r, conf.level = 0.95)$conf.int
  structure(list(power = power, conf.int = CI))
}

ttest.explore <- function(lown, topn, means, var, r = 10000, alternative = c("two.sided", "less", "greater"), mu = 0, alpha = 0.05, plotit = TRUE){
...
ttest.ppow <- function(x, y = NULL, n, r = 10000, alternative = c("two.sided", "less", "greater"), mu = NULL, alpha = 0.05){
  ...
  CI <- exactci(power*r, r, conf.level = 0.95)$conf.int
  structure(list(power = power, conf.int = CI))
}

ttest.pexplore <- function(x, y = NULL, lown, topn, r = 10000, alternative = c("two.sided", "less", "greater"), mu = NULL, alpha = 0.05, plotit = TRUE){
